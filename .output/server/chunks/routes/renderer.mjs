...
const appHead = {"meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no"}],"link":[{"rel":"icon","type":"image/x-icon","href":"/favicon.svg"},{"rel":"apple-touch-icon","sizes":"180x180","href":"/apple-touch-icon.png"},{"rel":"icon","type":"image/png","sizes":"32x32","href":"/favicon.svg"},{"rel":"icon","type":"image/png","sizes":"16x16","href":"/favicon.svg"},{"rel":"manifest","href":"/site.webmanifest"}],"style":[],"script":[{"src":"https://player.vimeo.com/api/player.js"}],"noscript":[],"charset":"utf-8","viewport":"width=device-width, initial-scale=1, viewport-fit=cover"};
