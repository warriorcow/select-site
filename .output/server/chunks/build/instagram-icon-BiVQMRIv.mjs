...
const __nuxt_component_4 = { render() {
  return h(NuxtIcon, { icon: { render }, name: "instagram-icon" });
} };

export { __nuxt_component_4 as default, render };
//# sourceMappingURL=instagram-icon-BiVQMRIv.mjs.map
