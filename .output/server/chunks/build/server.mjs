import { getCurrentInstance, ref, onBeforeMount, watch, isRef, reactive, onBeforeUnmount, computed, unref, inject, provide, isReactive, isReadonly, nextTick, createBlock, openBlock, withKeys, withModifiers, renderSlot, createVNode, createCommentVNode, withDirectives, Fragment, renderList, toDisplayString as toDisplayString$1, vShow, Transition, withCtx, createTextVNode, defineComponent, hasInjectionContext, toRef, h, resolveComponent, toRaw, toValue as toValue$1, resolveDynamicComponent, mergeProps, watchEffect, createElementBlock, createElementVNode, shallowRef, effectScope, onServerPrefetch, getCurrentScope, onScopeDispose, toRefs, markRaw, version, defineAsyncComponent, shallowReactive, Suspense, useSSRContext, createApp, Text, mergeModels, useModel, withAsyncContext, onErrorCaptured, isShallow } from 'vue';
import { h as hash, c as createError$1, s as sanitizeStatusCode, i as getContext, $ as $fetch, k as defu, l as createHooks, t as toRouteMatcher, m as createRouter$1, n as getRequestHeaders, o as destr, p as klona, q as parse$1, r as getRequestHeader, v as isEqual$1, w as setCookie, x as getCookie, y as deleteCookie } from '../nitro/nitro.mjs';
import { b as baseURL } from '../routes/renderer.mjs';
import { getActiveHead, CapoPlugin } from 'unhead';
import { defineHeadPlugin, composableNames } from '@unhead/shared';
import { useRoute as useRoute$1, RouterView, createMemoryHistory, createRouter, START_LOCATION } from 'vue-router';
import VueTheMask from 'vue-the-mask';
import { ssrRenderVNode, ssrInterpolate, ssrRenderSlot, ssrRenderComponent, ssrRenderAttrs, ssrRenderAttr, ssrRenderClass, ssrGetDynamicModelProps, ssrRenderTeleport, ssrRenderSuspense } from 'vue/server-renderer';
...
function useVuelidate(validations, state) {
  ...
  if (!validations && componentOptions.validations) {
    ...
    onBeforeMount(() => {
      ...
      watch(() => isFunction$1(rules) ? rules.call(state.value, new ComputedProxyFactory(state.value)) : rules, validations => {
      ...
      ($options.isSingleLabelVisible)
        ? (openBlock(), createBlock("span", {
            ...
            renderSlot(_ctx.$slots, "singleLabel", { option: $options.singleValue }, () => [
              createTextVNode(toDisplayString$1(_ctx.currentOptionLabel), 1 /* TEXT */)
            ])
          ], 32 /* HYDRATE_EVENTS */))
        : createCommentVNode("v-if", true),
      ($options.isPlaceholderVisible)
        ? (openBlock(), createBlock("span", {
            ...
            renderSlot(_ctx.$slots, "placeholder", {}, () => [
              createTextVNode(toDisplayString$1(_ctx.placeholder), 1 /* TEXT */)
            ])
          ], 32 /* HYDRATE_EVENTS */))
        : createCommentVNode("v-if", true)
    ], 512 /* NEED_PATCH */),
              ...
              ? (openBlock(), createBlock("li", _hoisted_4, [
                  createVNode("span", _hoisted_5, [
                    renderSlot(_ctx.$slots, "maxElements", {}, () => [
                      createTextVNode("Maximum of " + toDisplayString$1(_ctx.max) + " options selected. First remove a selected option to select another.", 1 /* TEXT */)
                    ])
                  ])
                ]))
              : createCommentVNode("v-if", true),
                    ...
                    (!(option && (option.$isLabel || option.$isDisabled)))
                      ? (openBlock(), createBlock("span", {
                          ...
                          renderSlot(_ctx.$slots, "option", {
                            ...
                            createVNode("span", null, toDisplayString$1(_ctx.getOptionLabel(option)), 1 /* TEXT */)
                          ])
...
const _routes = [
  {
    ...
    component: () => import('./_profile_-DVBimeGc.mjs')
  },
  {
    name: "profile___ru",
    path: "/ru/:profile()",
  ...
  },
  {
    name: "about___en",
    path: "/about",
    component: () => import('./about-CuhU5Kvs.mjs')
  },
  {
    name: "about___ru",
    path: "/ru/about",
  ...
  },
  {
    name: "contacts___en",
    path: "/contacts",
    component: () => import('./contacts-_dtr7CmM.mjs')
  },
  {
    name: "contacts___ru",
    path: "/ru/contacts",
  ...
  },
  {
    ...
    component: () => import('./index-BISuwMEQ.mjs')
  },
  {
    name: "index___ru",
    path: "/ru",
  ...
  {
    name: "models-catalog-category-type___en",
    path: "/models/:catalog()/:category?/:type?",
    component: () => import('./index-BH09dLuq.mjs')
  },
  {
    name: "models-catalog-category-type___ru",
    path: "/ru/models/:catalog()/:category?/:type?",
    component: () => import('./index-BH09dLuq.mjs')
  },
  {
    name: "models___en",
    path: "/models",
    component: () => import('./index-1wgmqHq3.mjs')
  },
  {
    name: "models___ru",
    path: "/ru/models",
  ...
  {
    name: "personal-data___en",
    path: "/personal-data",
    component: () => import('./personal-data-CEsC9iGv.mjs')
  },
  {
    name: "personal-data___ru",
    path: "/ru/personal-data",
    component: () => import('./personal-data-CEsC9iGv.mjs')
  },
  {
    name: "policy___en",
    path: "/policy",
    component: () => import('./policy-CEGgT8Ae.mjs')
  },
  {
    name: "policy___ru",
    path: "/ru/policy",
...
const LazySvgoArrow = defineAsyncComponent(() => import('./arrow-Bb7Shf0I.mjs').then((r) => r["default"] || r.default || r));
const LazySvgoCross = defineAsyncComponent(() => Promise.resolve().then(function() {
  return cross;
}).then((r) => r["default"] || r.default || r));
const LazySvgoInstagramIcon = defineAsyncComponent(() => import('./instagram-icon-BiVQMRIv.mjs').then((r) => r["default"] || r.default || r));
const LazySvgoPlay = defineAsyncComponent(() => import('./play-BXqtxUg5.mjs').then((r) => r["default"] || r.default || r));
const LazySvgoSelectLogo = defineAsyncComponent(() => import('./select-logo-BgSxl6qE.mjs').then((r) => r["default"] || r.default || r));
const LazySvgoThemePicker = defineAsyncComponent(() => import('./theme-picker-CWknbxit.mjs').then((r) => r["default"] || r.default || r));
const lazyGlobalComponents = [
  ["SvgoArrow", LazySvgoArrow],
  ["SvgoCross", LazySvgoCross],
  ["SvgoInstagramIcon", LazySvgoInstagramIcon],
  ["SvgoPlay", LazySvgoPlay],
  ["SvgoSelectLogo", LazySvgoSelectLogo],
  ["SvgoThemePicker", LazySvgoThemePicker]
];
...
function createViewportManager(options, state) {
  ...
  const queries = computed(() => {
    ...
    while (i--) {
      ...
      breakpoints[breakpointsKeys[i - 1]];
      let mediaQuery = "";
      {
        if (i > 0) {
...
const viewportOptions = { "breakpoints": { "desktop": 1201, "tablet": 600, "mobile": 321 }, "cookie": { "expires": 365, "name": "viewport", "path": "/", "sameSite": "Strict", "secure": true }, "defaultBreakpoints": { "desktop": "desktop", "mobile": "mobile", "tablet": "tablet" }, "fallbackBreakpoint": "desktop", "feature": "minWidth" };
...
const vuelidate_MzlagE1crG = /* @__PURE__ */ defineNuxtPlugin((nuxtApp) => {
...
const layouts = {
  default: () => import('./default-DUiXEhYo.mjs'),
  main: () => import('./main-BsJXT_K3.mjs'),
  profile: () => import('./profile-W2JZZrae.mjs')
};
...
function buildTree(items, pick2) {
  ...
  return pick2 ? tree.map((item) => applyPick(item, pick2)) : tree;
}
...
const useWindowStore = /* @__PURE__ */ defineStore("window", {
  state: () => ({
    token: null,
    breakpoint: null,
    language: "",
...
const useMenuStore = /* @__PURE__ */ defineStore("menu", {
  state: () => ({
    isMenuOpen: false,
    menu: null,
    bookingItem: null
  ...
  actions: {
    async fetchMenu() {
      ...
      try {
        ...
        if (data.value) {
          const bookingItemIndex = data.value.findIndex(
            (item) => item.acf && item.acf.slug === "booking"
          );
...
const _sfc_main$e = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const tooltipPopoverRef = ref(null);
    const isVisibleTooltip = ref(false);
    const isHovered = ref(false);
    computed(() => locale.value === "ru");
    onClickOutside(tooltipPopoverRef, () => isVisibleTooltip.value = false);
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "book-tooltip" }, _attrs))} data-v-c8ccc4a9><a target="_blank"${ssrRenderAttr("href", unref(bookingItem).url)} class="${ssrRenderClass([[unref(isHovered) && "hover"], "book-tooltip__circle group"])}" data-v-c8ccc4a9><div class="book-tooltip__content" data-v-c8ccc4a9>${ssrInterpolate(unref(bookingItem).title.rendered)}</div></a></div>`);
    };
  }
});
...
_sfc_main$e.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/book-tooltip/index.vue");
  return _sfc_setup$e ? _sfc_setup$e(props, ctx) : void 0;
};
const __nuxt_component_3 = /* @__PURE__ */ _export_sfc(_sfc_main$e, [["__scopeId", "data-v-c8ccc4a9"]]);
const _sfc_main$d = {
  props: {
    filled: {
      type: Boolean,
...
function render(_ctx, _cache) {
  return openBlock(), createElementBlock("svg", _hoisted_1, _cache[0] || (_cache[0] = [
    createElementVNode("path", {
      fill: "#000",
      d: "M9.445 11 .323 1.88A1.101 1.101 0 1 1 1.88.323L11 9.445 20.12.323a1.102 1.102 0 0 1 1.557 1.557L12.555 11l9.122 9.12a1.102 1.102 0 0 1-1.557 1.557L11 12.555l-9.12 9.122A1.101 1.101 0 0 1 .323 20.12L9.445 11Z"
    }, null, -1)
  ]));
}
const __nuxt_component_0$2 = { render() {
  return h(NuxtIcon, { icon: { render }, name: "cross" });
} };
...
const _sfc_main$c = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      let _temp0;
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "grid" }, _attrs))} data-v-1f80f577>`);
      if (_ctx.label) {
        _push(`<label class="mb-[5px] text-accent text-xs" data-v-1f80f577>${ssrInterpolate(_ctx.label)}</label>`);
      } else {
        _push(`<!---->`);
      }
      _push(`<input${ssrRenderAttrs((_temp0 = mergeProps(_ctx.$attrs, {
        ...
        class: ["focus:outline-secondary outline-offset-0 w-full border border-[#D9D9D9] h-[28px] py-1.5 m-0 px-2.5 rounded-[5px] placeholder-accent text-secondary text-xs", [
          _ctx.invalid && "border-[#ff0000]"
        ]],
        placeholder: _ctx.placeholder
      }), mergeProps(_temp0, ssrGetDynamicModelProps(_temp0, model.value))))} data-v-1f80f577></div>`);
    };
  }
});
...
const __nuxt_component_1$1 = /* @__PURE__ */ _export_sfc(_sfc_main$c, [["__scopeId", "data-v-1f80f577"]]);
defineComponent({
...
const _sfc_main$b = /* @__PURE__ */ defineComponent({
  ...
  emits: /* @__PURE__ */ mergeModels(["is-valid"], ["update:modelValue"]),
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "grid" }, _attrs))} data-v-575edd59>`);
      if (_ctx.label) {
        _push(`<label class="mb-[5px] text-accent text-xs" data-v-575edd59>${ssrInterpolate(_ctx.label)}</label>`);
      } else {
        _push(`<!---->`);
      }
      _push(ssrRenderComponent(_component_ClientOnly, { "fallback-tag": "span" }, {
        fallback: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="focus:outline-secondary outline-offset-0 w-full border border-[#D9D9D9] py-1.5 m-0 px-2.5 rounded-[5px] h-[28px] placeholder-accent text-secondary text-xs" data-v-575edd59${_scopeId}></div>`);
          } else {
            return [
              createVNode("div", { class: "focus:outline-secondary outline-offset-0 w-full border border-[#D9D9D9] py-1.5 m-0 px-2.5 rounded-[5px] h-[28px] placeholder-accent text-secondary text-xs" })
            ];
          }
        })
      }, _parent));
...
const __nuxt_component_2 = /* @__PURE__ */ _export_sfc(_sfc_main$b, [["__scopeId", "data-v-575edd59"]]);
const _sfc_main$a = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (_ctx.label) {
        _push(`<label class="mb-[5px] text-accent text-xs">${ssrInterpolate(_ctx.label)}</label>`);
      } else {
        _push(`<!---->`);
      }
      _push(ssrRenderComponent(unref(IMaskComponent), mergeProps(_ctx.$attrs, {
...
const _sfc_main$9 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "" }, _attrs))} data-v-051d7088><label class="text-xs text-accent mb-[5px] block" data-v-051d7088>${ssrInterpolate(_ctx.label)}</label>`);
      _push(ssrRenderComponent(unref(script), mergeProps({
        class: ["ui-select", { invalid: _ctx.invalid }],
        placeholder: _ctx.$t("ui.select.placeholder"),
        "show-pointer": false,
        "show-labels": false,
        "allow-empty": false
      }, _ctx.$attrs, { searchable: false }), null, _parent));
      _push(`</div>`);
    };
  }
});
...
const __nuxt_component_4 = /* @__PURE__ */ _export_sfc(_sfc_main$9, [["__scopeId", "data-v-051d7088"]]);
const _sfc_main$8 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<textarea${ssrRenderAttr("maxlength", _ctx.maxLength)} class="focus:outline-secondary outline-offset-0 resize-none min-h-[80px] w-full border border-[#D9D9D9] py-1.5 m-0 px-2.5 rounded-[5px] placeholder-accent text-secondary text-xs"${ssrRenderAttr("placeholder", _ctx.placeholder)}>${ssrInterpolate(model.value)}</textarea></div>`);
    };
  }
});
...
const _sfc_main$7 = /* @__PURE__ */ defineComponent({
  ...
  props: {
    ...
    isUnderlineHover: { type: Boolean },
    isUppercase: { type: Boolean },
    isCenter: { type: Boolean },
    isSelectColor: { type: Boolean },
    isSelectColorHover: { type: Boolean },
  ...
  setup(__props) {
    ...
    const props = __props;
    const buttonType = props.to ? __nuxt_component_3$1 : "button";
    return (_ctx, _push, _parent, _attrs) => {
      ssrRenderVNode(_push, createVNode(resolveDynamicComponent(unref(buttonType)), mergeProps({
        to: _ctx.to,
        class: ["ui-button", [
          ButtonColors[_ctx.color],
          ButtonSizes[_ctx.size],
          _ctx.isUnderline && "ui-button--underline",
          _ctx.isUnderlineHover && "ui-button--underline ui-button--underline-hover",
          _ctx.isUppercase && "ui-button--uppercase",
          _ctx.isCenter && "ui-button--center",
          _ctx.isSelectColor && "ui-button--select-color",
          _ctx.isSelectColorHover && "ui-button--select-color-hover",
          _ctx.isDisabled && "pointer-events-none"
        ]]
      }, _attrs), {
...
const __nuxt_component_0 = /* @__PURE__ */ _export_sfc(_sfc_main$7, [["__scopeId", "data-v-9838d6d4"]]);
...
const __nuxt_component_5$1 = /* @__PURE__ */ _export_sfc(_sfc_main$6, [["__scopeId", "data-v-521006cf"]]);
const _sfc_main$5 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      if (_ctx.isVisible) {
        _push(`<div${ssrRenderAttrs(mergeProps({ class: "overlay" }, _attrs))} data-v-eb34ff9e></div>`);
      } else {
        _push(`<!---->`);
      }
    };
...
const __nuxt_component_1 = /* @__PURE__ */ _export_sfc(_sfc_main$5, [["__scopeId", "data-v-eb34ff9e"]]);
const useCallbackModalStore = /* @__PURE__ */ defineStore("callback-modal", () => {
  useRouter();
  const { locale } = useI18n();
...
const _sfc_main$4 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    function checkValidNumber(isValid) {
      phoneIsValid.value = isValid;
    }
    function filterCyrillicText(event) {
      const input = event.target;
      input.value = input.value.replace(/[А-Яа-яЁё]/g, "");
    }
    return (_ctx, _push, _parent, _attrs) => {
      const _component_SvgoCross = __nuxt_component_0$2;
      const _component_UiInput = __nuxt_component_1$1;
      const _component_UiPhoneInput = __nuxt_component_2;
      const _component_UiDatePicker = _sfc_main$a;
      const _component_UiSelect = __nuxt_component_4;
      ...
      const _component_UiOverlay = __nuxt_component_1;
      ssrRenderTeleport(_push, (_push2) => {
        if (unref(isVisible)) {
          _push2(`<div class="flex fixed p-5 inset-0 z-[60] overflow-auto max-mobile:py-10 max-mobile:px-2.5 max-mobile:items-start">`);
          if (!unref(isSubmitted)) {
            _push2(`<div class="w-full max-w-[682px] bg-primary relative z-[60] m-auto">`);
            _push2(ssrRenderComponent(_component_SvgoCross, {
              class: "absolute top-[15px] right-[15px] cursor-pointer",
              onClick: unref(closeCallbackModal)
            }, null, _parent));
            _push2(`<div class="my-[45px] max-mobile:my-[30px] mx-[58px] max-mobile:mx-[15px]"><div><div class="text-6xl max-mobile:text-3xl uppercase mb-1.5">${ssrInterpolate(_ctx.$t("becomeAModel.title"))}</div><div class="text-sm max-mobile:text-xs text-accent">${ssrInterpolate(_ctx.$t("becomeAModel.description"))}</div></div><form class="grid gap-y-[20px] mt-[30px] max-mobile:mt-[28px]"><fieldset class="grid gap-y-[12px]"><legend class="text-lg max-mobile:text-md mb-2.5 text-nowrap">${ssrInterpolate(_ctx.$t("becomeAModel.form.first.title"))}</legend>`);
            _push2(ssrRenderComponent(_component_UiInput, {
              modelValue: unref(formState).fullName,
              "onUpdate:modelValue": ($event) => unref(formState).fullName = $event,
              invalid: unref(v$).fullName.$error,
              placeholder: _ctx.$t("becomeAModel.form.first.namePlaceholder"),
              maxlength: "50",
              onBlur: unref(v$).fullName.$touch
            }, null, _parent));
            _push2(`<div class="gap-x-[15px] gap-y-[12px] max-mobile:gap-y-2.5 grid grid-cols-2 max-mobile:grid-cols-1 w-full">`);
            _push2(ssrRenderComponent(_component_UiPhoneInput, {
              modelValue: unref(formState).phone,
              "onUpdate:modelValue": ($event) => unref(formState).phone = $event,
              label: _ctx.$t("becomeAModel.form.first.phone"),
              invalid: unref(v$).phone.$error,
              onBlur: unref(v$).phone.$touch,
              onIsValid: checkValidNumber
            }, null, _parent));
            _push2(ssrRenderComponent(_component_UiInput, {
              modelValue: unref(formState).email,
              "onUpdate:modelValue": ($event) => unref(formState).email = $event,
              invalid: unref(v$).email.$error,
              label: _ctx.$t("becomeAModel.form.first.email"),
              placeholder: "example@mail.com",
              onBlur: unref(v$).email.$touch
            }, null, _parent));
            _push2(ssrRenderComponent(_component_UiInput, {
              modelValue: unref(formState).city,
              "onUpdate:modelValue": ($event) => unref(formState).city = $event,
              invalid: unref(v$).city.$error,
              label: _ctx.$t("becomeAModel.form.first.city.text"),
              placeholder: _ctx.$t("becomeAModel.form.first.city.placeholder"),
              onBlur: unref(v$).city.$touch
            }, null, _parent));
            _push2(ssrRenderComponent(_component_UiDatePicker, {
              modelValue: unref(formState).dateOfBirth,
              "onUpdate:modelValue": ($event) => unref(formState).dateOfBirth = $event,
              invalid: unref(v$).dateOfBirth.$error,
              label: _ctx.$t("becomeAModel.form.first.dateOfBirth.text"),
              placeholder: "01.01.2001",
              onBlur: unref(v$).dateOfBirth.$touch
            }, null, _parent));
            _push2(`</div><div class="gap-x-[18px] max-mobile:gap-y-2.5 grid grid-cols-3 max-mobile:grid-cols-2 w-full">`);
            _push2(ssrRenderComponent(_component_UiSelect, {
              modelValue: unref(formState).maritalStatus,
              "onUpdate:modelValue": ($event) => unref(formState).maritalStatus = $event,
              invalid: unref(v$).maritalStatus.$error,
              label: _ctx.$t("becomeAModel.form.first.maritalStatus"),
              options: [
                _ctx.$t("becomeAModel.form.first.maritalStatusOptions.1"),
                _ctx.$t("becomeAModel.form.first.maritalStatusOptions.2"),
                _ctx.$t("becomeAModel.form.first.maritalStatusOptions.3"),
                _ctx.$t("becomeAModel.form.first.maritalStatusOptions.4")
              ],
              onBlur: unref(v$).maritalStatus.$touch
            }, null, _parent));
            _push2(`<div class="hidden max-mobile:block"></div>`);
            _push2(ssrRenderComponent(_component_UiInput, {
              modelValue: unref(formState).instagram,
              "onUpdate:modelValue": ($event) => unref(formState).instagram = $event,
              invalid: unref(v$).instagram.$error,
              label: _ctx.$t("becomeAModel.form.first.instagram"),
              placeholder: "@example",
              onBlur: unref(v$).instagram.$touch,
              onInput: ($event) => filterCyrillicText($event)
            }, null, _parent));
            _push2(ssrRenderComponent(_component_UiInput, {
              modelValue: unref(formState).telegram,
              "onUpdate:modelValue": ($event) => unref(formState).telegram = $event,
              invalid: unref(v$).telegram.$error,
              label: _ctx.$t("becomeAModel.form.first.telegram"),
              placeholder: "@example",
              onBlur: unref(v$).telegram.$touch,
              onInput: ($event) => filterCyrillicText($event)
            }, null, _parent));
            _push2(`</div></fieldset><fieldset class="grid gap-y-[12px]"><legend class="text-lg max-mobile:text-md mb-2.5 text-nowrap">${ssrInterpolate(_ctx.$t("becomeAModel.form.second.title"))}</legend><div class="gap-x-[18px] gap-y-[12px] max-mobile:gap-y-2.5 grid grid-cols-3 max-mobile:grid-cols-2 w-full">`);
            _push2(ssrRenderComponent(_component_UiInput, {
              modelValue: unref(formState).bust,
              "onUpdate:modelValue": ($event) => unref(formState).bust = $event,
              invalid: unref(v$).bust.$error,
              label: _ctx.$t("becomeAModel.form.second.bust"),
              onBlur: unref(v$).bust.$touch
            }, null, _parent));
            _push2(ssrRenderComponent(_component_UiInput, {
              modelValue: unref(formState).waist,
              "onUpdate:modelValue": ($event) => unref(formState).waist = $event,
              invalid: unref(v$).waist.$error,
              label: _ctx.$t("becomeAModel.form.second.waist"),
              onBlur: unref(v$).waist.$touch
            }, null, _parent));
            _push2(ssrRenderComponent(_component_UiInput, {
              modelValue: unref(formState).hips,
              "onUpdate:modelValue": ($event) => unref(formState).hips = $event,
              invalid: unref(v$).hips.$error,
              label: _ctx.$t("becomeAModel.form.second.hips"),
              onBlur: unref(v$).hips.$touch
            }, null, _parent));
            _push2(ssrRenderComponent(_component_UiSelect, {
              modelValue: unref(formState).clothingSize,
              "onUpdate:modelValue": ($event) => unref(formState).clothingSize = $event,
              invalid: unref(v$).clothingSize.$error,
              label: _ctx.$t("becomeAModel.form.second.clothingSize"),
              options: ["XS", "S", "M", "L", "XL", "XXL", "XXXL"],
              onBlur: unref(v$).clothingSize.$touch
            }, null, _parent));
            _push2(ssrRenderComponent(_component_UiInput, {
              modelValue: unref(formState).shoeSize,
              "onUpdate:modelValue": ($event) => unref(formState).shoeSize = $event,
              invalid: unref(v$).shoeSize.$error,
              label: _ctx.$t("becomeAModel.form.second.shoeSize"),
              onBlur: unref(v$).shoeSize.$touch
            }, null, _parent));
            _push2(ssrRenderComponent(_component_UiInput, {
              modelValue: unref(formState).height,
              "onUpdate:modelValue": ($event) => unref(formState).height = $event,
              invalid: unref(v$).height.$error,
              label: _ctx.$t("becomeAModel.form.second.height"),
              onBlur: unref(v$).height.$touch
            }, null, _parent));
            _push2(`</div></fieldset><fieldset class="grid gap-y-[12px]"><legend class="text-lg max-mobile:text-md mb-2.5 text-nowrap">${ssrInterpolate(_ctx.$t("becomeAModel.form.third.title"))}</legend><div class="gap-x-[15px] gap-y-[12px] max-mobile:gap-y-2.5 grid grid-cols-2 max-mobile:grid-cols-1 w-full">`);
            _push2(ssrRenderComponent(_component_UiInput, {
              modelValue: unref(formState).portfolio,
              "onUpdate:modelValue": ($event) => unref(formState).portfolio = $event,
              invalid: unref(v$).portfolio.$error,
              label: _ctx.$t("becomeAModel.form.third.linkToPortfolio"),
              onBlur: unref(v$).portfolio.$touch
            }, null, _parent));
            _push2(ssrRenderComponent(_component_UiInput, {
              modelValue: unref(formState).snaps,
              "onUpdate:modelValue": ($event) => unref(formState).snaps = $event,
              invalid: unref(v$).snaps.$error,
              label: _ctx.$t("becomeAModel.form.third.linkToSnaps"),
              onBlur: unref(v$).snaps.$touch
            }, null, _parent));
            _push2(ssrRenderComponent(_component_UiTextarea, {
              modelValue: unref(formState).about,
              "onUpdate:modelValue": ($event) => unref(formState).about = $event,
              "max-length": 500,
              class: "col-span-2 max-mobile:col-span-1",
              label: _ctx.$t("becomeAModel.form.third.about"),
              placeholder: _ctx.$t("becomeAModel.form.third.aboutPlaceholder")
            }, null, _parent));
            _push2(`</div></fieldset></form><div class="flex max-mobile:flex-col-reverse max-mobile:gap-y-2.5 items-end max-mobile:items-stretch mt-[24px] max-mobile:mt-2.5">`);
            _push2(ssrRenderComponent(_component_UiButton, {
              class: "mr-auto mb-1 max-mobile:!hidden",
              color: "accent",
              label: _ctx.$t("becomeAModel.footer.backButton"),
              size: "sm",
              "is-uppercase": "",
              "is-underline": "",
              onClick: unref(closeCallbackModal)
            }, null, _parent));
            _push2(`<div class="text-xs text-accent max-w-[245px] ml-2.5 max-mobile:max-w-full">${ssrInterpolate(_ctx.$t("becomeAModel.footer.policyText"))} `);
            _push2(ssrRenderComponent(_component_NuxtLink, {
              ...
              default: withCtx((_, _push3, _parent2, _scopeId) => {
                if (_push3) {
                  _push3(`${ssrInterpolate(_ctx.$t("becomeAModel.footer.policyLink"))}`);
                } else {
                  return [
                    createTextVNode(toDisplayString$1(_ctx.$t("becomeAModel.footer.policyLink")), 1)
                  ];
                }
              }),
              _: 1
            ...
            _push2(`</div><button class="${ssrRenderClass([[
              !unref(v$).$invalid && unref(phoneIsValid) && "bg-secondary"
            ], "flex items-center justify-center max-w-[217px] max-mobile:max-w-full w-full bg-[#D9D9D9] text-primary text-sm h-[37px] ml-[23px] max-mobile:ml-0"])}">`);
            if (unref(isSubmitting)) {
              _push2(ssrRenderComponent(_component_UiSpinner, {
                "is-adaptive": "",
                class: "absolute left-[23px]"
              }, null, _parent));
            } else {
              _push2(`<span>${ssrInterpolate(!unref(hasError) ? _ctx.$t("becomeAModel.footer.submitButton.text") : _ctx.$t("becomeAModel.footer.submitButton.error"))}</span>`);
            }
            _push2(`</button></div></div></div>`);
          } else {
            _push2(`<div class="w-full max-w-[560px] py-[90px] m-auto px-5 bg-primary relative z-[60]"><div class="max-w-[360px] mx-auto text-center"><div class="text-6xl uppercase">${ssrInterpolate(_ctx.$t("becomeAModel.thanks.title"))}</div><div class="text-lg mt-3 max-w-[270px] mx-auto">${ssrInterpolate(_ctx.$t("becomeAModel.thanks.description"))}</div>`);
            _push2(ssrRenderComponent(_component_UiButton, {
...
const _sfc_main$3 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      ssrRenderTeleport(_push, (_push2) => {
        if (unref(isVisible)) {
          _push2(`<div class="fixed bottom-0 left-0 right-0 z-50 bg-primary drop-shadow-[0px_1px_10px_rgba(0,0,0,0.2)] mobile:max-w-[393px] mobile:bottom-[36px] mobile:left-[14px]" data-v-dae5c774><div class="flex flex-col gap-y-2 px-5 py-3 mobile:justify-between" data-v-dae5c774><p class="text-accent text-sm" data-v-dae5c774>${ssrInterpolate(_ctx.$t("cookieBanner.text"))}</p>`);
          _push2(ssrRenderComponent(_component_NuxtLink, {
            ...
            default: withCtx((_, _push3, _parent2, _scopeId) => {
              if (_push3) {
                _push3(`${ssrInterpolate(_ctx.$t("cookieBanner.learnMore"))}`);
              } else {
                return [
                  createTextVNode(toDisplayString$1(_ctx.$t("cookieBanner.learnMore")), 1)
                ];
              }
            }),
            _: 1
          }, _parent));
          _push2(`<button class="ml-auto mobile:w-[163px] cookie-banner__btn flex items-center justify-center bg-secondary text-primary text-sm uppercase h-[37px] w-full mobile:w-auto mobile:shrink-0 mobile:px-10" data-v-dae5c774>${ssrInterpolate(_ctx.$t("cookieBanner.accept"))}</button></div></div>`);
        } else {
          _push2(`<!---->`);
        }
      }, "body", false, _parent);
...
_sfc_main$3.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/ui/CookieBanner.vue");
  return _sfc_setup$3 ? _sfc_setup$3(props, ctx) : void 0;
};
const __nuxt_component_5 = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["__scopeId", "data-v-dae5c774"]]);
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    const { closeMenu } = useMenuStore();
    {
      ...
      const { data } = ([__temp, __restore] = withAsyncContext(() => useApi(`/wp-json/jwt-auth/v1/token?username=${config.public.username}&password=${config.public.password}`, {
        method: "post",
        pick: ["token"]
      })), __temp = await __temp, __restore(), __temp);
      if ((_a = data.value) == null ? void 0 : _a.token) {
        setToken(data.value.token);
        [__temp, __restore] = withAsyncContext(() => fetchMenu()), await __temp, __restore();
      }
    }
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_BookTooltip = __nuxt_component_3;
      const _component_UiModal = _sfc_main$4;
      const _component_UiCookieBanner = __nuxt_component_5;
      _push(`<!--[-->`);
      ...
      _push(ssrRenderComponent(_component_NuxtLayout, null, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(``);
            _push2(ssrRenderComponent(_component_BookTooltip, {
              style: unref(pageIsVisible) ? null : { display: "none" }
            }, null, _parent2, _scopeId));
          } else {
            return [
              ...
              createVNode(Transition, { name: "page" }, {
                default: withCtx(() => [
                  withDirectives(createVNode(_component_BookTooltip, null, null, 512), [
                    [vShow, unref(pageIsVisible)]
                  ])
                ]),
                _: 1
              })
      ...
      _push(ssrRenderComponent(_component_UiModal, null, null, _parent));
      _push(ssrRenderComponent(_component_UiCookieBanner, null, null, _parent));
      _push(`<!--]-->`);
    };
  }
});
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_NuxtLayout, mergeProps({ name: "default" }, _attrs), {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="flex flex-col justify-center items-center h-full mb-10"${_scopeId}><h2 class="text-[180px] leading-none font-bold"${_scopeId}>${ssrInterpolate(_ctx.error.statusCode)}</h2><h3 class="text-6xl text-center uppercase max-w-lg mt-3"${_scopeId}>Looks like you&#39;ve landed on the wrong page</h3>`);
            _push2(ssrRenderComponent(_component_UiButton, {
              class: "mt-7",
              label: "back home",
              "is-underline": "",
            ...
            return [
              createVNode("div", { class: "flex flex-col justify-center items-center h-full mb-10" }, [
                createVNode("h2", { class: "text-[180px] leading-none font-bold" }, toDisplayString$1(_ctx.error.statusCode), 1),
                createVNode("h3", { class: "text-6xl text-center uppercase max-w-lg mt-3" }, "Looks like you've landed on the wrong page"),
...
export { NuxtIcon as N, _export_sfc as _, useWindowStore as a, useLocalePath as b, useApi as c, __nuxt_component_0 as d, entry$1 as default, useElementVisibility as e, defineStore as f, useRoute as g, useRouter as h, showError as i, useHead as j, __nuxt_component_3$1 as k, __nuxt_component_5$1 as l, useScroll as m, navigateTo as n, useSwitchLocalePath as o, useMenuStore as p, useCallbackModalStore as q, __nuxt_component_0$2 as r, storeToRefs as s, __nuxt_component_1 as t, useI18n as u };
