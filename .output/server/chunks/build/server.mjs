import { createBlock, openBlock, withKeys, withModifiers, renderSlot, createVNode, createCommentVNode, withDirectives, Fragment, renderList, toDisplayString as toDisplayString$1, vShow, Transition, withCtx, createTextVNode, defineComponent, ref, hasInjectionContext, inject, toRef, h, resolveComponent, computed, reactive, toRaw, isRef, isReactive, getCurrentInstance, toValue as toValue$1, resolveDynamicComponent, unref, mergeProps, watch, watchEffect, nextTick, createElementBlock, createElementVNode, shallowRef, effectScope, onServerPrefetch, getCurrentScope, onScopeDispose, provide, toRefs, markRaw, version, defineAsyncComponent, shallowReactive, Suspense, useSSRContext, createApp, Text, mergeModels, useModel, withAsyncContext, onErrorCaptured, isReadonly, isShallow } from 'vue';
...
import { minLength, required, numeric, email } from '@vuelidate/validators';
import 'node:http';
import 'node:https';
import 'node:fs';
import 'node:path';
...
const _routes = [
  ...
  },
  {
    ...
    component: () => import('./index-je34oioc.mjs')
  },
  {
    name: "index___ru",
    path: "/ru",
...
const useCallbackModalStore = /* @__PURE__ */ defineStore("callback-modal", () => {
  ...
  const v$ = Vuelidate(rules, formState);
