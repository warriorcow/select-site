...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  ...
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "h-dvh grid grid-rows-1" }, _attrs))}>`);
  _push(ssrRenderComponent(_component_Header, { theme: "light" }, null, _parent));
...
//# sourceMappingURL=main-BsJXT_K3.mjs.map
