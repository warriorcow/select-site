  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_Breadcrumbs, {
        items: [{
          name: unref(t)("pages.personalData.breadcrumbs.1"),
          link: "/",
          active: true
        }, {
          name: unref(t)("pages.personalData.breadcrumbs.2"),
          link: "/personal-data",
          active: false
        }]
      }, null, _parent));
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/personal-data.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=personal-data-CEsC9iGv.mjs.map
